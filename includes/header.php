<?php 
    ...
    session_start();
    define("APPURL", "http://localhost/CoffeeShop");
    define("IMAGEPRODUCTS", "http://localhost/CoffeeShop/admin-panel/products-admins/images");


?><!DOCTYPE html>
<html lang="en">
  <head>
    <title>Coffee - Voinn</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
      <link rel="icon" href="/CoffeeShop/images/voincafe.png" type="image/png" sizes="32x32">
  	...
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
            <a class="navbar-brand" href="<?php echo APPURL; ?>">
                <img src="/CoffeeShop/images/cafelogo1.png"  alt="CoffeeShop Logo" style="height: 100px; margin-top: 5px;">
            </a>
